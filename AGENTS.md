...
<!-- Weft codebase, generated by the deepinit skill. It is     -->
<!-- independent of the OMX/Codex runtime content above.           -->
<!-- ============================================================ -->
<!-- Generated: 2026-07-30 | Updated: 2026-07-30 -->

# Weft (project documentation)

## Purpose

A pre-affiliate Next.js (App Router) fashion discovery/search MVP for Lithuanian shoppers ("Weft"). Shoppers can search/filter a **synthetic demo catalog** (no live retailer products), browse neutral demo stores, and preview a product detail page — but no page redirects to a real merchant or completes a purchase. See `CLAUDE.md` (repo root) for the canonical architecture/commands writeup and `DESIGN.md` for the full brand/UX contract; this section is the deepinit hierarchy's entry point and defers to those two files for depth rather than duplicating them.
