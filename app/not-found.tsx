...
export default async function NotFound() {
  ...
  return (
    <div className="route-shell state-page">
      ...
      <p className="preview-kicker">{locale === "lt" ? "404 / INDEKSE NĖRA" : "404 / NOT IN THE INDEX"}</p>
      <h1>{locale === "lt" ? "Šios prekės čia nėra." : "This piece isn’t here."}</h1>
      <p>{locale === "lt" ? "Puslapis galėjo būti perkeltas arba ši sintetinė peržiūros prekė nepasiekiama." : "The page may have moved, or this synthetic preview item is unavailable."}</p>
