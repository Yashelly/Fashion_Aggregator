...
export const copy = {
  en: {
    frontend: {
      ...
      category: "Category", department: "Department", store: "Store", colour: "Colour", size: "Size", status: "Availability", saleOnly: "On sale",
      ...
      refineSearch: "Edit search",
      understoodNoMatchTitle: "We understood the request, but found no match.",
      understoodNoMatchLead: "Remove one understood detail or widen a filter. Your original words stay visible.",
      weakIntentTitle: "We need a little more detail.",
      weakIntentLead: "We could not confidently connect that description to this catalog. Try adding a garment, colour, or material.",
      originalQuery: (query: string) => `Your search: “${query}”`,
      ...
      savedPageTitle: "Saved pieces", savedPageLead: "Your saved pieces and recent searches, together in this browser.",
      ...
      clearSaved: "Clear saved pieces", clearRecent: "Clear recent searches",
    ...
    search: {
      ...
      interpretation: {
        ...
        remove: (label: string) => `Remove understood detail: ${label}`,
        garment: (value: string) => `Item: ${value}`,
        colour: (value: string) => `Colour: ${value}`,
        material: (value: string) => `Material: ${value}`,
        attribute: (value: string) => `Detail: ${value}`,
        exclusion: (value: string) => `Without: ${value}`,
        availability: (value: string) => `Availability: ${value}`,
        exact: "Exact matches",
  ...
  lt: {
    frontend: {
      ...
      category: "Kategorija", department: "Skyrius", store: "Parduotuvė", colour: "Spalva", size: "Dydis", status: "Prieinamumas", saleOnly: "Su nuolaida",
      ...
      refineSearch: "Patikslinti paiešką",
      understoodNoMatchTitle: "Užklausą supratome, bet atitikmens neradome.",
      understoodNoMatchLead: "Pašalink vieną suprastą detalę arba praplėsk filtrą. Pradinis tekstas liks matomas.",
      weakIntentTitle: "Reikia šiek tiek daugiau informacijos.",
      weakIntentLead: "Šio aprašymo nepavyko patikimai susieti su katalogu. Pridėk drabužį, spalvą arba medžiagą.",
      originalQuery: (query: string) => `Tavo paieška: „${query}“`,
      ...
      savedPageTitle: "Išsaugotos prekės", savedPageLead: "Tavo išsaugotos prekės ir naujausios paieškos šioje naršyklėje.",
      ...
      clearSaved: "Išvalyti išsaugotas prekes", clearRecent: "Išvalyti naujausias paieškas",
    ...
    search: {
      ...
      interpretation: {
        ...
        understood: "Supratome:",
        remove: (label: string) => `Pašalinti suprastą detalę: ${label}`,
        garment: (value: string) => `Prekė: ${value}`,
        colour: (value: string) => `Spalva: ${value}`,
        material: (value: string) => `Medžiaga: ${value}`,
        attribute: (value: string) => `Detalė: ${value}`,
        exclusion: (value: string) => `Be: ${value}`,
        availability: (value: string) => `Prieinamumas: ${value}`,
        exact: "Tikslūs atitikmenys",
        alternatives: "Panašios alternatyvos",
